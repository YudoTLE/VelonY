...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-inherit text-muted-foreground inline-flex h-9 w-fit items-center justify-center border-y-1",
        className
      )}
      {...props}
    />
